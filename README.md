# APIS-2018
APIS-2018 - Стандарт для интернет-магазинов работающих без своей базы данных 
по типу движка с открытым исходным кодом [API Shop](https://github.com/API-Shop/api-shop) разрабатываемого компанией PLLANO.com
