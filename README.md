...
«APIS-2018» — Стандарт обмена информацией между базами данных, торговыми платформами, интернет-магазинами, поставщиками товаров и сторонними сервисами через RESTful API интерфейс.

Стандарт используют: E-commerce Platform [«API Shop»](https://github.com/API-Shop/api-shop) и база данных на JSON файлах [«API json DB»](https://github.com/pllano/api-json-db) разработки компании PLLANO.com
